import {display} from './CustomFunctions.js'
import {Marks} from './ClasstoBeImported.js'
class Student {
...
const studentDetails = (students,RollNo)=>{
    ...
    display(`${student.RollNo}  |   ${student.Fname} ${student.Lname}  |  ${student.totalMarks}`);
}

const student1 = new Student("50","Miles","Morales");
const MarksOfStudent1Subject1 = new Marks("Physics",35);
const MarksOfStudent1Subject2 = new Marks("Physics",45);
const MarksOfStudent1Subject3 = new Marks("History",50);
...
const MarksOfStudent2Subject1 = new Marks("Maths",98);
const MarksOfStudent2Subject2 = new Marks("Physics",95);
const MarksOfStudent2Subject3 = new Marks("History",92);
...
const MarksOfStudent3Subject1 = new Marks("Maths",60);
const MarksOfStudent3Subject2 = new Marks("Physics",75);
const MarksOfStudent3Subject3 = new Marks("History",15);
...
display(PercentOfAllStudents);

const StudentsWithDistinction = studentWithDistinction(TotalStudents).length;

display(`Students with distinction ${StudentsWithDistinction}`);
